...
def stratified_split(files_by_label, ratios, random_seed=42):
...
files_dict = stratified_split(files_by_label, ratios=(0.7, 0.1, 0.1))

df = pd.read_csv("/mnt/disk1/aiotlab/namth/ds004796-download/meta.csv", encoding="utf-8", sep=",")  # đổi sep nếu ; hoặc \t
...
db = lmdb.open('/mnt/disk1/aiotlab/namth/EEGFoundationModel/datasets/pearl', map_size=1000000000)
